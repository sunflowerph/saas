...
#新增供应商
    def test_ab_add_supplier(self):
        test_add_suuplier = base.add_supplier(base.supplier1,u"供商5",u'彭女士','17301000000','111113445958',u'法人彭女士',u'大渡河')
        #执行新增供应商操作
        time.sleep(3)
...
#新增产品
    def test_d_add_goods(self):
        test_add_goods = base.add_goods(base.sku,u'大西瓜',u"大品牌",'1823849','180',u"供应商03",u"企业名称","180",'23')
        #新增产品操作
        time.sleep(2)
...
if __name__ == "__main__":
    ...
    # 将测试用例加入到测试容器中
    testunit.addTest(TestMarket("test_ab_add_supplier"))#新增供应商
    testunit.addTest(TestMarket("test_b_edit_supplier"))
    testunit.addTest(TestMarket(""))
    testunit.addTest(TestMarket(""))
    testunit.addTest(TestMarket(""))
    testunit.addTest(TestMarket(""))
    testunit.addTest(TestMarket(""))
    ...
    runner = HTMLTestRunner.HTMLTestRunner(
            stream=fp, title=u'saas超市系统测试报告', description=u'用例执行情况:')
        # 运行测试用例
    runner.run(testunit)
    fp.close()
